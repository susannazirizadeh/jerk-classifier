...
for crossval=1:1000
    ...
    LOOerror(1,7)= lme1.ModelCriterion.AIC;
    LOOerror(1,8)= lme2.ModelCriterion.AIC;
    LOOerror(1,9)= lme3.ModelCriterion.AIC;
    LOOerror(1,10)= lme1.ModelCriterion.BIC;
    LOOerror(1,11)= lme2.ModelCriterion.BIC;
    LOOerror(1,12)=lme3.ModelCriterion.BIC;   
end
