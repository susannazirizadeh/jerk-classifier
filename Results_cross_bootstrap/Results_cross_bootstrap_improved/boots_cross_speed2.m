...
final_error1=zeros(4,24);
final_error2=zeros(4,24);
final_error3=zeros(4,24);
...
for device= 2%:4
        ...
        LOOerror1=zeros(1000,12);
        LOOerror2=zeros(1000,12);
        LOOerror3=zeros(1000,12);
        n=250;
        bootindex{device}{1}(:,:)=randi(length(C5),n,1000);
        bootindex{device}{2}(:,:)=randi(length(C8),n,1000);
        bootindex{device}{3}(:,:)=randi(length(C12),n,1000);
        parfor nboot=1:1000
        ...
        final_error1(device,19)= mean(LOOerror1(:,7));  % AIC lme1
        final_error1(device,20)= mean(LOOerror1(:,8));  % AIC lme2
        final_error1(device,21)= mean(LOOerror1(:,9));  % AIC lme3   
        final_error1(device,22)= mean(LOOerror1(:,10));  % BIC lme1
        final_error1(device,23)= mean(LOOerror1(:,11));  % BIC lme2
        final_error1(device,24)= mean(LOOerror1(:,12));  % BIC lme3
        ...
        final_error2(device,19)= mean(LOOerror2(:,7));  % AIC lme1
        final_error2(device,20)= mean(LOOerror2(:,8));  % AIC lme2
        final_error2(device,21)= mean(LOOerror2(:,9));  % AIC lme3   
        final_error2(device,22)= mean(LOOerror2(:,10));  % BIC lme1
        final_error2(device,23)= mean(LOOerror2(:,11));  % BIC lme2
        final_error2(device,24)= mean(LOOerror2(:,12));  % BIC lme3
        ...
        final_error3(device,19)= mean(LOOerror3(:,7));  % AIC lme1
        final_error3(device,20)= mean(LOOerror3(:,8));  % AIC lme2
        final_error3(device,21)= mean(LOOerror3(:,9));  % AIC lme3   
        final_error3(device,22)= mean(LOOerror3(:,10));  % BIC lme1
        final_error3(device,23)= mean(LOOerror3(:,11));  % BIC lme2
        final_error3(device,24)= mean(LOOerror3(:,12));  % BIC lme3
