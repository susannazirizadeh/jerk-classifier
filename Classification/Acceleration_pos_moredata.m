...
%% Calculating results.acc_pos of outdoor session for classifier 
                    ...
                    if isempty(classification_data.acc_pos{m}{n}{o}) ~= 1
                        for p=1:5%length(con)
                            if isempty(classification_data.acc_pos{m}{n}{o}{p}) ~= 1
                                for i= 1:250:length(classification_data.acc_pos{m}{n}{o}{p})
                                    if i+500 < length(classification_data.acc_pos{m}{n}{o}{p}) % Windowing, window length= 500 data points (5 seconds) with 50% overlapping
                                        
                                        sum_window = sum(classification_data.acc_pos{m}{n}{o}{p}(i:i+499,2));
                                        count_nonzero = sum(classification_data.acc_pos{m}{n}{o}{p}(i:i+499,3));
                                ...
                                if isempty(classification_data.acc_pos{m}{3}{o}{p}) ~= 1 %GPS with 1Hz sampling frequency , window 5s
                                    for i= 1:3:length(classification_data.acc_pos{m}{3}{o}{p})
                                        if i+3 < length(classification_data.acc_pos{m}{3}{o}{p})
                                            mloadrate.outdoor{m}{3}{o}{p}((i + 2) / 3,1)= (nanmean(classification_data.acc_pos{m}{3}{o}{p}(i:i+2,3)))*3.6;
                        ...
                        for p= 6:7
                            if isempty(classification_data.acc_pos{m}{n}{o}{p}) ~= 1
                                for i= 1:50:length(classification_data.acc_pos{m}{n}{o}{p})
                                    if i+100 < length(classification_data.acc_pos{m}{n}{o}{p}) % Windowing, window length= 500 data points (5 seconds) with 50% overlapping
                                        
                                        sum_window = sum(classification_data.acc_pos{m}{n}{o}{p}(i:i+99,2));
                                        count_nonzero = sum(classification_data.acc_pos{m}{n}{o}{p}(i:i+99,3));
                ...
                if isempty( mloadrate.outdoor{m}{n}{o} ) ~= 1
                    for  p=1:length(con)
                        if isempty( mloadrate.outdoor{m}{n}{o}{p} ) ~= 1
                            ...
                            results.acc_pos{n}{m}(1:length(SP),:)= SP; %loadrate smartphone
                        end
                    end
                end
            end
