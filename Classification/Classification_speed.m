...
C1=[results.jerk_pos{1}{1}(:,1),results.jerk_all{1}{1}(:,1),results.acc_pos{1}{1}(:,1),results.acc_all{1}{1}(:,:),results.acc_all{3}{1}(:,1)];
C2=[results.jerk_pos{1}{2}(:,1),results.jerk_all{1}{2}(:,1),results.acc_pos{1}{2}(:,1),results.acc_all{1}{2}(:,:),results.acc_all{3}{2}(:,1)];
C3=[results.jerk_pos{1}{3}(:,1),results.jerk_all{1}{3}(:,1),results.acc_pos{1}{3}(:,1),results.acc_all{1}{3}(:,:),results.acc_all{3}{3}(:,1)];
C4=[results.jerk_pos{1}{4}(:,1),results.jerk_all{1}{4}(:,1),results.acc_pos{1}{4}(:,1),results.acc_all{1}{4}(:,:),results.acc_all{3}{4}(:,1)];
C5=[results.jerk_pos{1}{5}(:,1),results.jerk_all{1}{5}(:,1),results.acc_pos{1}{5}(:,1),results.acc_all{1}{5}(:,:),results.acc_all{3}{5}(:,1)];
C6=[results.jerk_pos{1}{6}(:,1),results.jerk_all{1}{6}(:,1),results.acc_pos{1}{6}(:,1),results.acc_all{1}{6}(:,:),results.acc_all{3}{6}(:,1)];
C7=[results.jerk_pos{1}{7}(:,1),results.jerk_all{1}{7}(:,1),results.acc_pos{1}{7}(:,1),results.acc_all{1}{7}(:,:),results.acc_all{3}{7}(:,1)];
C8=[results.jerk_pos{1}{8}(:,1),results.jerk_all{1}{8}(:,1),results.acc_pos{1}{8}(:,1),results.acc_all{1}{8}(:,:),results.acc_all{3}{8}(:,1)];
C9=[results.jerk_pos{1}{9}(:,1),results.jerk_all{1}{9}(:,1),results.acc_pos{1}{9}(:,1),results.acc_all{1}{9}(:,:),results.acc_all{3}{9}(:,1)];
C10=[results.jerk_pos{1}{10}(:,1),results.jerk_all{1}{10}(:,1),results.acc_pos{1}{10}(:,1),results.acc_all{1}{10}(:,:),results.acc_all{3}{10}(:,1)];
C11=[results.jerk_pos{1}{11}(:,1),results.jerk_all{1}{11}(:,1),results.acc_pos{1}{11}(:,1),results.acc_all{1}{11}(:,:),results.acc_all{3}{11}(:,1)];
C12=[results.jerk_pos{1}{12}(:,1),results.jerk_all{1}{12}(:,1),results.acc_pos{1}{12}(:,1),results.acc_all{1}{12}(:,:),results.acc_all{3}{12}(:,1)];
