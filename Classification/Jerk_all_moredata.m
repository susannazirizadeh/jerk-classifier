                    ...
                    if isempty( raw_int.outdoor{m}{n}{o}) ~= 1
                        for p=1:5%length(con)   % Conditions
                            if isempty( raw_int.outdoor{m}{n}{o}{p}) ~= 1
                                ...
                                [classification_data.jerk_all{m}{n}{o}{p}(:,2),classification_data.jerk_all{m}{n}{o}{p}(:,3),classification_data.jerk_all{m}{n}{o}{p}(:,4)]=jerk_all(a(500:end-500,1),b(500:end-500,1:4));
                                classification_data.jerk_all{m}{n}{o}{p}(:,1)=a(500:end-500,1);
                            end
                        end
                        for p=6:7 %length(con)   % Conditions
                            if isempty( raw_int.outdoor{m}{n}{o}{p}) ~= 1
                                ...
                                [classification_data.jerk_all{m}{n}{o}{p}(:,2),classification_data.jerk_all{m}{n}{o}{p}(:,3),classification_data.jerk_all{m}{n}{o}{p}(:,4)]=jerk_all(a(10:end-10,1),b(10:end-10,1:4));
                                classification_data.jerk_all{m}{n}{o}{p}(:,1)=a(10:end-10,1);
                                end
                            end
                        end
                    end
            ...
            if isempty(raw_int.outdoor{m}{n}) ~= 1
                for o=1:length(speed)   % Speed
                    if isempty( raw_int.outdoor{m}{n}{o}) ~= 1
                        for p=1:5%length(con)   % Conditions
                            if isempty(raw_int.outdoor{m}{n}{o}{p}) ~= 1
                                classification_data.jerk_all{m}{n}{o}{p}(:,1:3)=raw_int.outdoor{m}{n}{o}{p}(500:end-500,1:3);
                            end
                        end
                        for p=6:7%length(con)   % Conditions
                            if isempty(raw_int.outdoor{m}{n}{o}{p}) ~= 1
                                classification_data.jerk_all{m}{n}{o}{p}(:,1:3)=raw_int.outdoor{m}{n}{o}{p}(10:end-10,1:3);
                            end
                        end
                    end
                end
                ...
                if isempty( mloadrate.outdoor{m}{n}{o} ) ~= 1
                    for  p=1:length(con)
                        if isempty( mloadrate.outdoor{m}{n}{o}{p} ) ~= 1
                            ...
                            results.jerk_all{n}{m}(1:length(SP),1:5)= SP; %loadrate smartphone
                            a=GPS(:,1);
                            results.jerk_all{n}{m}(1:length(GPS),6)= a;
                        end
                    end
                end
            end
