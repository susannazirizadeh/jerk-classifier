...
C1(:,1:9)=([results.jerk_pos{1}{1}(:,:);results.jerk_pos{1}{2}(:,:);results.jerk_pos{1}{3}(:,:);results.jerk_pos{1}{4}(:,:);results.jerk_pos{1}{5}(:,:);results.jerk_pos{1}{6}(:,:);results.jerk_pos{1}{7}(:,:);results.jerk_pos{1}{8}(:,:);results.jerk_pos{1}{9}(:,:);results.jerk_pos{1}{10}(:,:);results.jerk_pos{1}{11}(:,:);results.jerk_pos{1}{12}(:,:)]);
...
C_act_ter=[C1(:,1),C2(:,1),C3(:,1),C4(:,1),C1(:,8),C1(:,7),C1(:,9)];
