...
%     med_asphalt_part=asphalt_part(find(asphalt_part>1.5e+7 & asphalt_part<upper),1);
...
%     med_grass_part=grass_part(find(grass_part>1.5e+7 & grass_part<upper),1);
...
%     med_soil_part=soil_part(find(soil_part>1.5e+7 & soil_part<upper),1);
...
%     Z=[length(low_soil_part) length(med_soil_part) length(high_soil_part)];
    ...
    med_inclineup_part=inclineup_part(find(inclineup_part>1.5e+7 & inclineup_part<upper),1);
    high_inclineup_part=inclineup_part(find(inclineup_part(:,1)>upper),1);
    ...
    med_inclinedown_part=inclinedown_part(find(inclinedown_part>1.5e+7 & inclinedown_part<upper),1);
    high_inclinedown_part=inclinedown_part(find(inclinedown_part(:,1)>upper),1);
    ...
    med_stairsup_part=stairsup_part(find(stairsup_part>1.5e+7 & stairsup_part<upper),1);
    high_stairsup_part=stairsup_part(find(stairsup_part(:,1)>upper),1);
    ...
    med_stairsdown_part=stairsdown_part(find(stairsdown_part>1.5e+7 & stairsdown_part<upper),1);
    high_stairsdown_part=stairsdown_part(find(stairsdown_part(:,1)>upper),1);
...
%     Z=[length(low_soil_part) length(med_soil_part) length(high_soil_part)];
    ...
    low_inclineup_part=inclineup_part(find(inclineup_part<lower),1);
    med_inclineup_part=inclineup_part(find(inclineup_part>lower & inclineup_part<upper),1);
    high_inclineup_part=inclineup_part(find(inclineup_part(:,1)>upper),1);
    A=[length(low_inclineup_part) length(med_inclineup_part) length(high_inclineup_part)];
    
    inclinedown_part=Xtest(find(Xtest(:,25)==5),1);
    low_inclinedown_part=inclinedown_part(find(inclinedown_part<lower),1);
    med_inclinedown_part=inclinedown_part(find(inclinedown_part>lower & inclinedown_part<upper),1);
    high_inclinedown_part=inclinedown_part(find(inclinedown_part(:,1)>upper),1);
    B=[length(low_inclinedown_part) length(med_inclinedown_part) length(high_inclinedown_part)];
    
    stairsup_part=Xtest(find(Xtest(:,25)==6),1);
    low_stairsup_part=stairsup_part(find(stairsup_part<lower),1);
    med_stairsup_part=stairsup_part(find(stairsup_part>lower & stairsup_part<upper),1);
    high_stairsup_part=stairsup_part(find(stairsup_part(:,1)>upper),1);
    C=[length(low_stairsup_part) length(med_stairsup_part) length(high_stairsup_part)];
    
    stairsdown_part=Xtest(find(Xtest(:,25)==7),1);
    low_stairsdown_part=stairsdown_part(find(stairsdown_part<lower),1);
    med_stairsdown_part=stairsdown_part(find(stairsdown_part>lower & stairsdown_part<upper),1);
    high_stairsdown_part=stairsdown_part(find(stairsdown_part(:,1)>upper),1);
    D=[length(low_stairsdown_part) length(med_stairsdown_part) length(high_stairsdown_part)];
