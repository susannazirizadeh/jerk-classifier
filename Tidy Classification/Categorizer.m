...
low_walk=walk(find(walk<1.5e+7),1);
med_walk=walk(find(walk>1.5e+7 & walk<2.56e+7),1);
high_walk=walk(find(walk(:,1)>2.5e+7),1);
...
med_jog=jog(find(jog>1.5e+7 & jog<2.56e+7),1);
high_jog=jog(find(jog(:,1)>2.5e+7),1);
...
low_run=run(find(run<1.5e+7),1);
med_run=run(find(run>1.5e+7 & run<2.56e+7),1);
high_run=run(find(run(:,1)>2.5e+7),1);
...
low_slow_stairs=slow_stairs(find(slow_stairs<1.5e+7),1);
med_slow_stairs=slow_stairs(find(slow_stairs>1.5e+7 & slow_stairs<2.56e+7),1);
high_slow_stairs=slow_stairs(find(slow_stairs(:,1)>2.5e+7),1);
...
low_fast_stairs=fast_stairs(find(fast_stairs<1.5e+7),1);
med_fast_stairs=fast_stairs(find(fast_stairs>1.5e+7 & fast_stairs<2.56e+7),1);
high_fast_stairs=fast_stairs(find(fast_stairs(:,1)>2.5e+7),1);
...
for participant=[1:4 6:12]
    ...
    low_walk_part=walk_part(find(walk_part<1.5e+7),1);
    med_walk_part=walk_part(find(walk_part>1.5e+7 & walk_part<2.56e+7),1);
    high_walk_part=walk_part(find(walk_part(:,1)>2.5e+7),1);
    X=[length(low_walk_part) length(med_walk_part) length(high_walk_part)];
    
    jog_part=Xtest(find(Xtest(:,21)==2),1);
    low_jog_part=jog_part(find(jog_part<1.5e+7),1);
    med_jog_part=jog_part(find(jog_part>1.5e+7 & jog_part<2.56e+7),1);
    high_jog_part=jog_part(find(jog_part(:,1)>2.5e+7),1);
    Y=[length(low_jog_part) length(med_jog_part) length(high_jog_part)];
    
    run_part=Xtest(find(Xtest(:,21)==3),1);
    low_run_part=run_part(find(run_part<1.5e+7),1);
    med_run_part=run_part(find(run_part>1.5e+7 & run_part<2.56e+7),1);
    high_run_part=run_part(find(run_part(:,1)>2.5e+7),1);
    Z=[length(low_run_part) length(med_run_part) length(high_run_part)];
    
    slow_stairs_part=Xtest(find(Xtest(:,21)==4),1);
    low_slow_stairs_part=slow_stairs_part(find(slow_stairs_part<1.5e+7),1);
    med_slow_stairs_part=slow_stairs_part(find(slow_stairs_part>1.5e+7 & slow_stairs_part<2.56e+7),1);
    high_slow_stairs_part=slow_stairs_part(find(slow_stairs_part(:,1)>2.5e+7),1);
    ...
    low_fast_stairs_part=fast_stairs_part(find(fast_stairs_part<1.5e+7),1);
    med_fast_stairs_part=fast_stairs_part(find(fast_stairs_part>1.5e+7 & fast_stairs_part<2.56e+7),1);
    high_fast_stairs_part=fast_stairs_part(find(fast_stairs_part(:,1)>2.5e+7),1);
